...
ft_lstnew.c ft_itoa.c ft_create_items.c ft_time.c dhexchange.c make_rand_str.c sha256.c get_ip.c get_port.c \
checksum.c read_file.c _strsplit.c random.c ft_llist_splice.c ft_reverse_llist.c __ss_init_llist_crt.c \
__ss_push_back.c __ss_llist_crt_push_front.c callback.c
OBJ = $(SRC:.c=.o)
INC = ./inc/
